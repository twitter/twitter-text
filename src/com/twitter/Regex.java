...
public class Regex {
  ...
  **/
  ...
  public static final Pattern AUTO_LINK_USERNAMES_OR_LISTS = Pattern.compile("([^a-z0-9_]|^|RT:?)(" + AT_SIGNS + "+)([a-z0-9_]{1,20})(/[a-z][a-z0-9_\\-\\x80-\\xFF-]{0,24})?($|.)", Pattern.CASE_INSENSITIVE);
