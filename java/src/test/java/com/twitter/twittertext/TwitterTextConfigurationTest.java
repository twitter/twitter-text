...
public class TwitterTextConfigurationTest extends TestCase {
  ...
  public void testJsonAsString() {
    final TwitterTextConfiguration configuration =
        TwitterTextConfiguration.configurationFromJson("{\"version\": 1, \"maxWeightedTweetLength\": 30, " +
            "\"scale\": 1, \"defaultWeight\": 1, \"transformedURLLength\": 14, \"ranges\": [{\"start\": 0, " +
            "\"end\": 4351, \"weight\": 2}]}", false);
    ...
    final List<TwitterTextConfiguration.TwitterTextWeightedRange> ranges = configuration.getRanges();
  ...
  public void testVersion1() {
    final TwitterTextConfiguration configuration = TwitterTextConfiguration.configurationFromJson("v1.json", true);
    assertEquals(configuration.getVersion(), 1);
  ...
  public void testVersion2() {
    final TwitterTextConfiguration configuration = TwitterTextConfiguration.configurationFromJson("v2.json", true);
    ...
    final TwitterTextConfiguration.TwitterTextWeightedRange spacesGeneralPunctuationBlock = ranges.get(1);
    ...
    final TwitterTextConfiguration.TwitterTextWeightedRange visibleGeneralPunctuationBlock1 = ranges.get(2);
    ...
    final TwitterTextConfiguration.TwitterTextWeightedRange visibleGeneralPunctuationBlock2 = ranges.get(3);
