...
public class Regex {
  ...
  private static final String URL_VALID_PRECEEDING_CHARS = "(?:[^a-z0-9@＠$#＃" + INVALID_CHARACTERS + "]|^)";
  ...
  private static final String URL_VALID_UNICODE_CHARS = "[^" + PUNCTUATION_CHARS + "\\s\\p{Z}\\p{InGeneralPunctuation}]";
  private static final String URL_VALID_UNICODE_DOMAIN_NAME = "(?:(?:" + URL_VALID_UNICODE_CHARS + "[" +
  ...
  **/
  ...
  static {
    synchronized(Regex.class) {
      ...
      VALID_HASHTAG = Pattern.compile("(^|\\uFE0E|\\uFE0F|[^&" + HASHTAG_LETTERS_NUMERALS + "])([#\uFF03])(?![\uFE0F\u20E3])(" + HASHTAG_LETTERS_NUMERALS_SET + "*" + HASHTAG_LETTERS_SET + HASHTAG_LETTERS_NUMERALS_SET + "*)", Pattern.CASE_INSENSITIVE);
